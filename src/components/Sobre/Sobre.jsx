  ...
  return (
    <div id="sobre">
      ...
      <div className={style.content}>
        ...
        A representada está presente em mais de 90 países e cinco continentes, oferece equipamentos e 
        acessórios digitais inteligentes de última geração, duráveis e seguros, seus desenvolvedores 
        produzem e atualizam constantemente as diversas tecnologias, a manuserv transmite confiança e 
